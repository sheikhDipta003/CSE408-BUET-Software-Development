...
const markAsRead = async (req, res) => {
    try {
      ...
      const notification = await Notification.findOne({ where: { notifId: notificationId, userId: userId } });
...
const deleteNotification = async (req, res) => {
    try {
      ...
      // Check if the notification belongs to the user
      const notif = await Notification.findOne({ where: { notifId: notificationId, userId: userId } })
