...
async function setPriceDropAlert(req, res) {
    try {
        ...
        return res.status(201).json({ message: 'Price drop alert set successfully', priceDrop });
    } catch (error) {
...
async function removePriceDropAlert(req, res) {
    try {
        ...
        return res.status(200).json({ message: 'Price drop alert removed successfully' });
    } catch (error) {
...
module.exports = { setPriceDropAlert, viewPriceDropAlerts, removePriceDropAlert };
