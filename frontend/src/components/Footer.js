...
const Footer = () => {
    ...
    return (
        <footer id="footer" className= "text-xl text-black w-full bg-[#66d8f5] p-3 flex justify-between items-center place-content-center">
            ...
            <nav className="hidden flex-col gap-2 md:flex" aria-label="footer">
                <Link to="/about" className="hover:opacity-90">About Us</Link>
                <Link to="/home" className="hover:opacity-90">Terms and Conditions</Link>
                <Link to="/home" className="hover:opacity-90">Privacy Policy</Link>
                <Link to="/home" className="hover:opacity-90">Contact Us</Link>
            </nav>
