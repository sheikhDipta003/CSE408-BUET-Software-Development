...
import ColVoucherManage from './ColVoucherManage';
        ...
        <div className="flex justify-center py-8">
            <div className="flex">
                <div className="min-w-32 p-4 border-r border-red-500">
                    ...
                    <ul>
                        <li className={`cursor-pointer ${activeMenu === 'Vouchers' ? 'text-red-500 font-bold' : 'text-black'} mb-4`} onClick={() => handleMenuClick('Vouchers')}>Vouchers</li>
                        <li className={`cursor-pointer ${activeMenu === 'Events' ? 'text-red-500 font-bold' : 'text-black'} mb-4`} onClick={() => handleMenuClick('Events')}>Events</li>
