...
const Home2 = () => {
    const features = [
        {
          ...
          details: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi suscipit congue purus, eget vulputate tortor rhoncus vel. Nunc convallis diam quis erat dapibus, sit amet molestie ex vestibulum.',
          imageUrl: feature1
        },
        {
          text: 'Bookmark products of interest. Receive notifications when a better deal or discount surfaces.',
          details: 'Suspendisse maximus sit amet lacus mattis tristique. Cras ornare lacus id molestie ullamcorper. Fusce a purus quam.',
          imageUrl: feature2
        },
        {
          text: 'Search, sort, and filter through a wide range of products.',
          details: 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus non ornare arcu.',
          imageUrl: feature3
        }
      ];
      ...
      const testimonials = [
        {
          comment: "TechShoppers has been a game-changer for me! The intuitive interface and real-time price updates make it a breeze to find the best deals on tech products. The comprehensive comparisons have saved me both time and money. Highly recommended for anyone looking to make informed tech purchases!",
          username: "Lynna Sewill"
        },
        {
          comment: "TechShoppers is my go-to destination for tech deals. The website's clean design and user-friendly layout make it easy to navigate. I love how it provides detailed information and price comparisons on a wide range of gadgets. It's like having a personal tech advisor at my fingertips!",
          username: "Mariana Ezzle"
        },
        {
          comment: "Discovering TechShoppers was a revelation! The ability to compare prices across various platforms is a game-changer for someone like me who loves a good deal. The notifications for price drops have saved me a significant amount on my recent purchases. TechShoppers is a must-have tool for any savvy shopper!",
  ...
  return (
    <div className="mx-auto p-8">
      ...
      <section className="mb-8 scroll-smooth">
        ...
        <div className="flex flex-col items-center space-y-8">
          {features.map((feature, index) => (
            <div key={index} className={`flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 ${index % 2 === 0 ? 'sm:flex-row-reverse' : ''} border-4 rounded-lg shadow-lg`}>
              <div className='flex flex-col justify-between space-y-2'>
                <p className="text-4xl text-left p-4 underline decoration-indigo-500 decoration-2 underline-offset-4">{feature.text}</p>
      ...
      {showTopBtn && (
        <button onClick={scrollToTop} className="fixed bottom-5 right-5 w-12 h-12 rounded-full border-none bg-blue-500 text-white text-2xl flex items-center justify-center cursor-pointer transition-opacity duration-1000 z-50 opacity-100">
