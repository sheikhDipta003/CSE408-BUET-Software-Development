...
const Users = () => {
  ...
  const handleDeleteSelected = async () => {
    ...
    try {
      await Promise.all(
        selectedVouchers.map((user) => handleDelete(user.userId)),
      );
    } catch (error) {
          ...
          <thead>
            <tr>
              ...
              >
                ...
                {sortBy !== "username" && (
                  <FontAwesomeIcon icon={faSort} className="ml-2 text-black" />
                )}
              </th>
              <th
              ...
              >
                User Role
                {sortBy === "userRole" && sortOrder === "asc" && (
                  <FontAwesomeIcon
                    icon={faSortUp}
                    className="ml-2 text-black"
                  />
                )}
                {sortBy === "userRole" && sortOrder === "desc" && (
                  <FontAwesomeIcon
                    icon={faSortDown}
                    className="ml-2 text-black"
                  />
                ...
                <>
                  <tr key={user.userId}>
                    ...
                    <td className="border border-gray-200 px-4 py-2 relative flex items-center">
                      ...
                      <button
                        className="ml-4 bg-stone-200 mt-0 mb-0"
                    ...
                    >
                      <div className="sticky top-0 right-0 z-40 sidebar-header flex justify-center bg-violet-300 p-0 m-0">
                        ...
                        >
                          <FontAwesomeIcon
                            icon={faTimes}
                            className="text-red-500 mb-2 size-6 hover:text-red-800"
                          />
                        </button>
                      </div>
                      ...
                      <div className="bg-white w-full h-full mt-10 px-4">
                        <div className="p-2 border-b-4 border-red-400">
                          <h2 className="text-lg font-semibold inline items-center">
                            Interactions
                          </h2>
                          <button
                        ...
                        <div
                          className={`p-4 border-b-4 border-red-400 ${openSections.interactions ? "" : "hidden"}`}
                        >
                        ...
                        <div
                          className={`p-4 border-b-4 border-red-400 ${openSections.notifications ? "" : "hidden"}`}
                        >
                        ...
                        <div
                          className={`p-4 border-b-4 border-red-400 ${openSections.vouchers ? "" : "hidden"}`}
                        >
                        ...
                        <div
                          className={`p-4 border-b-4 border-red-400 ${openSections.wishlist ? "" : "hidden"}`}
                        >
