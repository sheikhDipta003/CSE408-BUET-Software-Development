        ...
        <th key={index}>
          <div className="product-header relative">
            ...
            <div
              ...
              onClick={() => handleCouponIconClick(product.coupon)}
            >
    ...
    <div className="product-details">
      ...
      <div className="carousel">
        ...
        <button
          className="arrow-button"
          onClick={slideRight}
          disabled={visibleStartIndex === headerData.length - 2}
        >
      ...
      {showSidebar && (
        <div
          className={`sidebar fixed top-0 right-0 w-64 bg-white h-screen overflow-y-auto p-4 transform ${showSidebar ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out h-full shadow-lg z-50`}
        >
          ...
          <div className="sidebar-content p-4">
            ...
            <p className="mb-4">
              Enter your desired price for the product and we'll notify you when
              it drops to or below this price.
            </p>
            <input
              type="number"
              value={alertPrice}
          ...
          <div className="sidebar-footer flex justify-between mt-4 px-2">
            ...
            <button
              className={`bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-r ${!isValidInput && "opacity-50 cursor-not-allowed"}`}
              disabled={!isValidInput}
              onClick={handleCreatePriceDropClick}
            >
              Create Alert
            </button>
          </div>
